...
private List<Ksiazka> ksiazki = new ArrayList<Ksiazka>(){
    private static final long serialVersionUID = 1L;
    {
        ...
        add(Ksiazka.produceKsiazka(2L,"Gra o tron","Książka jak książka",229.99,"George R.R. Martin","Fantasy",KsiazkaUtils.getDateWithYearAndMonthForDay(1996,8,1),Stan.DO_SPRZEDANIA));
        add(Ksiazka.produceKsiazka(3L,"Hobbit","Książka jak książka",45.50,"John Ronald Reuel Tolkien","Fantasy",KsiazkaUtils.getDateWithYearAndMonthForDay(1937,9,21),Stan.DO_SPRZEDANIA));
        ...
        add(Ksiazka.produceKsiazka(7L,"Egzekutor","Książka jak książka",74.99,"Chris Carter","Dreszczowiec",KsiazkaUtils.getDateWithYearAndMonthForDay(2013,5,4),Stan.NOWA));
        add(Ksiazka.produceKsiazka(8L,"Umysł początkującego","Książka",119.99,"Shunryu Suzuki","Filozofia zen",KsiazkaUtils.getDateWithYearAndMonthForDay(2010,8,12),Stan.DO_SPRZEDANIA));
        add(Ksiazka.produceKsiazka(9L,"Arrow","Książka jak książka",69.99,"Bruce Lee","Fikcja",KsiazkaUtils.getDateWithYearAndMonthForDay(2012,5,7),Stan.DUBLET));
        add(Ksiazka.produceKsiazka(10L,"Egzekutor","Książka jak książka",74.99,"Chris Carter","Dreszczowiec",KsiazkaUtils.getDateWithYearAndMonthForDay(2013,5,4),Stan.DUBLET));
    }
